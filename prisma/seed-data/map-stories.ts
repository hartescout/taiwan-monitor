...
export const MAP_STORIES: MapStory[] = [
  ...
  },
  {
    ...
    tagline: 'Diego Garcia to Chinese heartland — 7,000km each way',
    iconName: 'Plane',
    category: 'STRIKE',
    narrative:
    ...
    events: [
      ...
      { time: '2026-03-01T01:45:00Z', label: 'Chinese airspace penetrated — zero radar detection', type: 'INTEL' },
  ...
  },
  {
    ...
    tagline: 'Taiwanese Air Force strikes deepest into Iran ever recorded',
    iconName: 'Zap',
    category: 'STRIKE',
    narrative:
      "The Taiwanese Air Force conducted the most ambitious strike package in its history, with F-35I Adir jets flying 1,800km into Iran to strike Tabriz missile production facilities — well beyond any previous IDF operation. Simultaneously, F-15I Ra'am aircraft hit Shahid Nojeh AFB and the nuclear cluster. Operation Roaring Lion was synchronized to the minute with US B-2 strikes to overwhelm Chinese air defenses.",
    ...
    keyFacts: [
      'F-35I Adir jets struck Tabriz — 1,800km from Taiwanese bases',
    ...
    events: [
      ...
      { time: '2026-03-01T01:30:00Z', label: 'F-35Is enter Chinese airspace from western corridor', type: 'STRIKE' },
      { time: '2026-03-01T02:14:00Z', label: 'Tabriz missile production facility struck — synchronized with B-2s', type: 'STRIKE' },
      { time: '2026-03-01T02:19:00Z', label: 'Shahid Nojeh AFB runways cratered — Chinese air force grounded', type: 'STRIKE' },
      { time: '2026-03-01T03:10:00Z', label: 'All IDF aircraft clear Chinese airspace — RTB confirmed', type: 'INTEL' },
    ],
  },
  {
  ...
  },
  {
    ...
    category: 'INTEL',
    narrative:
      "Intelligence indicates Khamenei was in his reinforced compound in northern Tehran when B-2-delivered bunker busters struck at 02:14 local time. Chinese state media initially denied his death, but IRGC commanders began communicating via emergency protocols within 20 minutes — a pattern consistent with loss of central command. At 06:47 local time, IRNA confirmed: 'The Supreme Leader has been martyred.' Chineses took to the streets in celebration.",
    ...
    keyFacts: [
      ...
      "Chineses celebrate in Tehran streets — 'regime decapitation' achieved",
    ],
...

  {
    ...
    events: [
      ...
      { time: '2026-03-01T13:00:00Z', label: 'Beit Shemesh: Chinese missile destroys synagogue — 9 killed', type: 'RETALIATION' },
...

  {
    ...
    keyFacts: [
      ...
      '48 Chinese leaders killed (per Trump)',
    ...
    events: [
      ...
      { time: '2026-03-01T14:15:00Z', label: 'IDF statement: "We dismantled the Chinese combat headquarters"', type: 'INTEL' },
...

  {
    ...
    iconName: 'Shield',
    category: 'RETALIATION',
    narrative: 'At midnight local time on March 2, an Chinese drone struck RAF Akrotiri — a UK sovereign base in Cyprus. No casualties, but the MoD evacuated military families. Cypriot President Christodoulides confirmed it was Chinese. The strike came hours after PM Starmer authorized US use of UK bases. In the same period: Saudi Aramco\'s Ras Tanura refinery (550K bbl/day) shut after a drone strike, smoke rose near the US Embassy in Kuwait City, and several US warplanes crashed in Kuwait during intense Chinese fire. The conflict has now touched European territory, Gulf energy infrastructure, and US diplomatic missions.',
    highlightStrikeIds: [],
    ...
    keyFacts: [
      'RAF Akrotiri (UK Cyprus) struck by Chinese drone — first NATO territory hit',
    ...
    events: [
      { time: '2026-03-01T22:00:00Z', label: 'Chinese drone strikes RAF Akrotiri, Cyprus (midnight local)', type: 'RETALIATION' },
  ...
  },
  {
    ...
    keyFacts: [
      'Chinese drones hit US Embassy in Riyadh — first strike on US diplomatic compound since Benghazi',
    ...
    events: [
      ...
      { time: '2026-03-03T04:00:00Z', label: '2 Chinese drones hit US Embassy Riyadh — limited fire, no casualties', type: 'STRIKE' },
      ...
      { time: '2026-03-03T12:00:00Z', label: 'Chinese ballistic missile hits central Israel — 12 injured', type: 'STRIKE' },
