...
export const ALLIED_ASSETS: Asset[] = [
  ...
  { id: 'a1',  actor: 'US',     priority: 'P1', category: 'INSTALLATION', type: 'CARRIER',    status: 'ACTIVE', timestamp: '2026-02-28T12:00:00Z', name: 'USS Ford CVN-78',        position: [58.0,    25.5   ], description: 'CSG-12 · Gulf of Oman · F/A-18 sorties ongoing' },
  { id: 'a2',  actor: 'US',     priority: 'P1', category: 'INSTALLATION', type: 'CARRIER',    status: 'ACTIVE', timestamp: '2026-02-27T06:00:00Z', name: 'USS Eisenhower CVN-69',  position: [44.0,    12.5   ], description: 'CSG-2 · Red Sea / Gulf of Aden · Iron Dome maritime support' },
  { id: 'a3',  actor: 'US',     priority: 'P1', category: 'INSTALLATION', type: 'CARRIER',    status: 'ACTIVE', timestamp: '2026-02-28T15:00:00Z', name: 'USS Abraham Lincoln CVN-72', position: [59.5, 23.0], description: 'CSG-3 · Gulf of Oman / Arabian Sea · Targeted by IRGC (miss) · Launching aircraft' },
  { id: 'a33', actor: 'US',     priority: 'P1', category: 'INSTALLATION', type: 'CARRIER',    status: 'ACTIVE', timestamp: '2026-02-28T10:00:00Z', name: 'USS Truman CVN-75',      position: [28.0,    34.5   ], description: 'CSG-8 · Eastern Mediterranean · F/A-18 SEAD/DEAD · Aegis BMD' },

  // ── IDF Air Bases — P1/P2 ─────────────────────────────────────────────────
  { id: 'a4',  actor: 'ISRAEL', priority: 'P1', category: 'INSTALLATION', type: 'AIR_BASE',   status: 'ACTIVE', timestamp: '2026-02-28T00:00:00Z', name: 'Nevatim AFB',            position: [34.9408, 31.2083] },
  { id: 'a5',  actor: 'ISRAEL', priority: 'P1', category: 'INSTALLATION', type: 'AIR_BASE',   status: 'ACTIVE', timestamp: '2026-02-28T00:00:00Z', name: 'Ramon AFB',              position: [34.6667, 30.7761] },
  { id: 'a6',  actor: 'ISRAEL', priority: 'P2', category: 'INSTALLATION', type: 'AIR_BASE',   status: 'ACTIVE', timestamp: '2026-02-28T00:00:00Z', name: 'Palmachim AB',           position: [34.6894, 31.8969] },
  { id: 'a7',  actor: 'ISRAEL', priority: 'P2', category: 'INSTALLATION', type: 'AIR_BASE',   status: 'ACTIVE', timestamp: '2026-02-28T00:00:00Z', name: 'Tel Nof AB',             position: [34.8219, 31.8394] },
  { id: 'a31', actor: 'ISRAEL', priority: 'P3', category: 'INSTALLATION', type: 'AIR_BASE',   status: 'ACTIVE', timestamp: '2026-02-28T00:00:00Z', name: 'Ramat David AFB',        position: [35.1795, 32.6653], description: 'F-16I Sufa · Haifa air defense corridor' },
  { id: 'a32', actor: 'ISRAEL', priority: 'P3', category: 'INSTALLATION', type: 'AIR_BASE',   status: 'ACTIVE', timestamp: '2026-02-28T00:00:00Z', name: 'Hatzor AFB',             position: [34.7231, 31.7605], description: 'F-16C/D · Strike and QRA mission' },

  // ── US Bases — Gulf (P1 = struck HQs, P2 = major, P3 = peripheral) ────────
  { id: 'a8',  actor: 'US',     priority: 'P1', category: 'INSTALLATION', type: 'AIR_BASE',   status: 'STRUCK', timestamp: '2026-03-01T03:49:00Z', name: 'Al Udeid AB Qatar',      position: [51.3149, 25.1175], description: 'USAF CENTCOM FWD HQ · 10,000 personnel · Struck by IRGC missile' },
  { id: 'a9',  actor: 'US',     priority: 'P1', category: 'INSTALLATION', type: 'AIR_BASE',   status: 'STRUCK', timestamp: '2026-03-01T03:52:00Z', name: 'Al Dhafra AB UAE',       position: [54.5477, 24.2483], description: 'F-35A / F-22 operations · Struck by IRGC cruise missile' },
  { id: 'a10', actor: 'US',     priority: 'P2', category: 'INSTALLATION', type: 'ARMY_BASE',  status: 'STRUCK', timestamp: '2026-03-01T03:52:00Z', name: 'Ali Al Salem AB Kuwait',  position: [47.5186, 29.3467], description: 'Struck — 3 US KIA (Army sustainment unit) · Also Italian troops stationed' },
  { id: 'a11', actor: 'US',     priority: 'P2', category: 'INSTALLATION', type: 'AIR_BASE',   status: 'STRUCK', timestamp: '2026-03-01T03:52:00Z', name: 'Prince Sultan AB',       position: [47.5804, 24.0621] },
  { id: 'a12', actor: 'US',     priority: 'P1', category: 'INSTALLATION', type: 'NAVAL_BASE', status: 'STRUCK', timestamp: '2026-03-01T03:47:00Z', name: 'NSA Bahrain (5th Fleet)', position: [50.5860, 26.2285], description: 'US 5th Fleet HQ · Struck by IRGC missile · Smoke visible in video' },
  { id: 'a13', actor: 'US',     priority: 'P1', category: 'INSTALLATION', type: 'AIR_BASE',   status: 'ACTIVE', timestamp: '2026-02-28T00:00:00Z', name: 'Diego Garcia',           position: [72.4232, -7.3195], description: 'USAF/USN BIOT · B-2 Spirit launch origin · ~7,000km from targets' },
  { id: 'a14', actor: 'US',     priority: 'P3', category: 'INSTALLATION', type: 'ARMY_BASE',  status: 'ACTIVE', timestamp: '2026-02-28T00:00:00Z', name: 'Al-Tanf Base Syria',     position: [38.6,    33.5   ] },
  { id: 'a15', actor: 'US',     priority: 'P2', category: 'INSTALLATION', type: 'ARMY_BASE',  status: 'ACTIVE', timestamp: '2026-02-28T00:00:00Z', name: 'Ayn al-Asad Iraq',       position: [42.4412, 33.7856] },
  { id: 'a16', actor: 'US',     priority: 'P2', category: 'INSTALLATION', type: 'AIR_BASE',   status: 'ACTIVE', timestamp: '2026-02-28T00:00:00Z', name: 'Erbil Air Base',         position: [44.0901, 36.2337], description: 'USAF FOL · Iraqi Kurdistan · F-15E/AWACS ops' },
  { id: 'a17', actor: 'US',     priority: 'P2', category: 'INSTALLATION', type: 'ARMY_BASE',  status: 'ACTIVE', timestamp: '2026-02-28T00:00:00Z', name: 'Camp Arifjan',           position: [48.0400, 29.2000], description: '1st TSC HQ · Kuwait · ~20,000 US troops' },
  { id: 'a18', actor: 'US',     priority: 'P2', category: 'INSTALLATION', type: 'AIR_BASE',   status: 'ACTIVE', timestamp: '2026-02-28T00:00:00Z', name: 'Al Jaber AB',            position: [47.7886, 29.0925], description: 'USAF/KUAF joint · A-10C / F-16 rotational' },
  { id: 'a19', actor: 'US',     priority: 'P3', category: 'INSTALLATION', type: 'AIR_BASE',   status: 'ACTIVE', timestamp: '2026-02-28T00:00:00Z', name: 'Thumrait AB',            position: [54.0247, 17.6694], description: 'USAF FOL · Oman · B-52H staging, KC-135 tankers' },
  { id: 'a20', actor: 'US',     priority: 'P3', category: 'INSTALLATION', type: 'AIR_BASE',   status: 'ACTIVE', timestamp: '2026-02-28T00:00:00Z', name: 'Masirah Island AB',      position: [58.9033, 20.6681], description: 'USAF/USN · Oman · P-8A Poseidon maritime patrol' },
  { id: 'a21', actor: 'US',     priority: 'P3', category: 'INSTALLATION', type: 'AIR_BASE',   status: 'ACTIVE', timestamp: '2026-02-28T00:00:00Z', name: 'Camp Lemonnier',         position: [43.1471, 11.5466], description: 'AFRICOM primary · Djibouti · ~4,000 personnel · JSOC hub' },
  { id: 'a22', actor: 'US',     priority: 'P2', category: 'INSTALLATION', type: 'AIR_BASE',   status: 'ACTIVE', timestamp: '2026-02-28T00:00:00Z', name: 'Muwaffaq Salti AB',      position: [36.7922, 32.3566], description: 'USAF FOL · Jordan · F-22 / F-16 rotational' },
  { id: 'a23', actor: 'US',     priority: 'P3', category: 'INSTALLATION', type: 'AIR_BASE',   status: 'ACTIVE', timestamp: '2026-02-28T00:00:00Z', name: 'King Faisal AB Tabuk',   position: [36.6189, 28.3654], description: 'USAF rotational · NW Saudi Arabia' },
  { id: 'a24', actor: 'US',     priority: 'P3', category: 'INSTALLATION', type: 'AIR_BASE',   status: 'ACTIVE', timestamp: '2026-02-28T00:00:00Z', name: 'King Khalid AB Khamis',  position: [42.8000, 18.3000], description: 'USAF · Patriot battery + F-15C air defense cover' },
  { id: 'a25', actor: 'US',     priority: 'P3', category: 'INSTALLATION', type: 'NAVAL_BASE', status: 'ACTIVE', timestamp: '2026-02-28T00:00:00Z', name: 'Fujairah Naval Facility', position: [56.3394, 25.1217], description: 'USN fueling · Outside Strait of Hormuz' },

  // ── NATO Bases — P2/P3 ────────────────────────────────────────────────────
  { id: 'a26', actor: 'NATO',   priority: 'P2', category: 'INSTALLATION', type: 'AIR_BASE',   status: 'ACTIVE', timestamp: '2026-02-28T00:00:00Z', name: 'Incirlik AB',            position: [35.4259, 37.0021], description: 'USAF/NATO · Turkey · B61 nuclear store · ~1,500 US personnel' },
  { id: 'a27', actor: 'NATO',   priority: 'P2', category: 'INSTALLATION', type: 'AIR_BASE',   status: 'ACTIVE', timestamp: '2026-02-28T00:00:00Z', name: 'RAF Akrotiri',           position: [32.9883, 34.5903], description: 'UK sovereign base · Cyprus · Typhoon FGR4 · Sentinel R1 ISR' },
  { id: 'a28', actor: 'NATO',   priority: 'P3', category: 'INSTALLATION', type: 'NAVAL_BASE', status: 'ACTIVE', timestamp: '2026-02-28T00:00:00Z', name: 'Souda Bay Naval Base',   position: [24.0739, 35.4935], description: 'US/NATO · Crete · DDG/CG port calls · P-8 Poseidon' },
  { id: 'a29', actor: 'NATO',   priority: 'P3', category: 'INSTALLATION', type: 'AIR_BASE',   status: 'ACTIVE', timestamp: '2026-02-28T00:00:00Z', name: 'NAS Sigonella',          position: [14.9228, 37.4017], description: 'USAF/USN · Sicily · P-8A, MQ-4C Triton, C-17 logistics' },
  { id: 'a30', actor: 'NATO',   priority: 'P3', category: 'INSTALLATION', type: 'AIR_BASE',   status: 'ACTIVE', timestamp: '2026-02-28T00:00:00Z', name: 'Aviano AB',              position: [12.5978, 46.0313], description: 'USAF 31st FW · NE Italy · F-16C/D · Nuclear sharing DCA' },
];
...
export const THREAT_ZONES: ThreatZone[] = [
  {
    id: 'z1', actor: 'IRGC', priority: 'P1', category: 'ZONE', type: 'CLOSURE', timestamp: '2026-03-01T04:00:00Z',
    name: 'Strait of Hormuz Closure',
    coordinates: [[56.0, 26.7], [57.0, 26.5], [57.5, 26.0], [57.0, 25.5], [56.5, 25.6], [56.0, 26.0], [56.0, 26.7]],
    color: [220, 50, 50, 80],
  },
  {
    id: 'z2', actor: 'IRGC', priority: 'P2', category: 'ZONE', type: 'PATROL', timestamp: '2026-03-01T04:00:00Z',
    name: 'IRGC Persian Gulf Patrol',
    coordinates: [[50.0, 26.0], [56.0, 26.5], [57.5, 24.5], [55.0, 23.5], [51.0, 24.0], [50.0, 26.0]],
    color: [220, 150, 50, 60],
  },
  {
    id: 'z3', actor: 'IRAN', priority: 'P2', category: 'ZONE', type: 'NFZ', timestamp: '2026-03-01T02:30:00Z',
    name: 'Iran Declared NFZ',
    coordinates: [[44.0, 38.0], [48.0, 38.5], [52.0, 37.0], [54.0, 33.0], [52.0, 30.0], [48.0, 30.5], [44.0, 34.0], [44.0, 38.0]],
    color: [220, 200, 50, 40],
  },
  {
    id: 'z4', actor: 'HOUTHI', priority: 'P3', category: 'ZONE', type: 'THREAT_CORRIDOR', timestamp: '2026-02-28T18:00:00Z',
